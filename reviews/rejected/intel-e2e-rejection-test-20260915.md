...
- Rejected at: 2026-09-15T23:04:47Z
- Pull request: #6
- Pull request URL: https://github.com/SaltyDogBibleApp/SaltyDogBibleContent/pull/6
...
## TEST ONLY — Reserve Intel Rejection Lifecycle
...
Controlled test of the Reserve Intel rejected-review lifecycle.

### Why It Matters

This test verifies that closing a review PR without merging archives the draft as rejected.

### Details

TEST ONLY. This draft must be closed without merge and must never be published to the live Reserve Intel feed.
...
- Tagging basis: controlled rejection lifecycle test
- Note: TEST ONLY. This item must be rejected and must never be published.
...
<!-- reserve-intel-article-id: intel-e2e-rejection-test-20260915 -->
